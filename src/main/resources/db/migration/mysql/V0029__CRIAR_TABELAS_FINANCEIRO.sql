...
CREATE TABLE FIN_BANCO_AGENCIA (
    ...
    ID_FIN_BANCO BIGINT(20), FOREIGN KEY (ID_FIN_BANCO) REFERENCES FIN_BANCO(ID),
...
-- TIPO DE RECEBIMENTO
-- ---------------------------------------------------
CREATE TABLE FIN_RECEBIMENTO_TIPO (
    ID BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
    DESCRICAO VARCHAR(100),
    INATIVO BOOLEAN DEFAULT FALSE
)
...
CREATE TABLE FIN_PARCELA_RECEBER (
    ...
    ID_FIN_PARCELA_STATUS BIGINT(20),       FOREIGN KEY (ID_FIN_PARCELA_STATUS) REFERENCES FIN_PARCELA_STATUS(ID),
...
CREATE TABLE FIN_PARCELA_RECEBIMENTO (
    ID BIGINT(20) PRIMARY KEY AUTO_INCREMENT,
    ID_FIN_RECEBIMENTO_TIPO BIGINT(20),     FOREIGN KEY (ID_FIN_RECEBIMENTO_TIPO) REFERENCES FIN_RECEBIMENTO_TIPO(ID),
    ID_FIN_CHEQUE_RECEBIDO BIGINT(20),      FOREIGN KEY (ID_FIN_CHEQUE_RECEBIDO) REFERENCES FIN_CHEQUE_RECEBIDO(ID),
    ID_FIN_BANCO_CONTA BIGINT(20),          FOREIGN KEY (ID_FIN_BANCO_CONTA) REFERENCES  FIN_BANCO_CONTA(ID),
    ID_FIN_PARCELA_RECEBER BIGINT(20),      FOREIGN KEY (ID_FIN_PARCELA_RECEBER) REFERENCES  FIN_PARCELA_RECEBER(ID),
