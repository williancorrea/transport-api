...
public class BancoExtratoAbreviacaoRepositoryImpl implements BancoExtratoAbreviacaoRepositoryQuery {
    ...
    @Override
    public Page<BancoExtratoAbreviacao> findAll(BancoExtratoAbreviacaoRepositoryFiltro filtro, Pageable pageable) {
     ...
     */
    public int quantidadeRegistrosFiltrados(BancoExtratoAbreviacaoRepositoryFiltro filtro) {
        Criteria criteria = criarCriteriaParaFiltro(filtro);
     ...
     * @return
     */
    private Criteria criarCriteriaParaFiltro(BancoExtratoAbreviacaoRepositoryFiltro filtro) {
        Session session = manager.unwrap(Session.class);
        Criteria criteria = session.createCriteria(BancoExtratoAbreviacao.class);
