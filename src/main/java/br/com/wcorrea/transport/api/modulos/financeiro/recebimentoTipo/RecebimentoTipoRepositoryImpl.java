...
public class RecebimentoTipoRepositoryImpl implements RecebimentoTipoRepositoryQuery {

    @PersistenceContext
    private EntityManager manager;

    @Override
    public Page<RecebimentoTipo> findAll(RecebimentoTipoRepositoryFiltro filtro, Pageable pageable) {
     ...
     * @return
     */
    public int quantidadeRegistrosFiltrados(RecebimentoTipoRepositoryFiltro filtro) {
        Criteria criteria = criarCriteriaParaFiltro(filtro);
     ...
     * @return
     */
    private Criteria criarCriteriaParaFiltro(RecebimentoTipoRepositoryFiltro filtro) {
        Session session = manager.unwrap(Session.class);
        Criteria criteria = session.createCriteria(RecebimentoTipo.class);
