...
public class PlanoContaRepositoryImpl implements PlanoContaRepositoryQuery {
    ...
    @Override
    public Page<PlanoConta> findAll(PlanoContaRepositoryFiltro filtro, Pageable pageable) {
     ...
     * @return
     */
    public int quantidadeRegistrosFiltrados(PlanoContaRepositoryFiltro filtro) {
        Criteria criteria = criarCriteriaParaFiltro(filtro);
     ...
     * @return
     */
    private Criteria criarCriteriaParaFiltro(PlanoContaRepositoryFiltro filtro) {
