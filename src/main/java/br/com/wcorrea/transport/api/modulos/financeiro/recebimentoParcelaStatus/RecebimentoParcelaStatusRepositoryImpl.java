...
import br.com.wcorrea.transport.api.modulos.financeiro.recebimentoParcelaStatus.RecebimentoParcelaStatusRepositoryFiltro;
...
public class RecebimentoParcelaStatusRepositoryImpl implements RecebimentoParcelaStatusRepositoryQuery {

    @PersistenceContext
    private EntityManager manager;

    @Override
    public Page<RecebimentoParcelaStatus> findAll(RecebimentoParcelaStatusRepositoryFiltro filtro, Pageable pageable) {
     ...
     * @return
     */
    public int quantidadeRegistrosFiltrados(RecebimentoParcelaStatusRepositoryFiltro filtro) {
        Criteria criteria = criarCriteriaParaFiltro(filtro);
     ...
     * @return
     */
    private Criteria criarCriteriaParaFiltro(RecebimentoParcelaStatusRepositoryFiltro filtro) {
        Session session = manager.unwrap(Session.class);
        Criteria criteria = session.createCriteria(RecebimentoParcelaStatus.class);
