...
public class RecebimentoLancamentoRepositoryImpl implements RecebimentoLancamentoRepositoryQuery {

    @PersistenceContext
    private EntityManager manager;

    @Override
    public Page<RecebimentoLancamento> findAll(RecebimentoLancamentoRepositoryFiltro filtro, Pageable pageable) {
     ...
     * @return
     */
    public int quantidadeRegistrosFiltrados(RecebimentoLancamentoRepositoryFiltro filtro) {
        Criteria criteria = criarCriteriaParaFiltro(filtro);
     ...
     * @return
     */
    private Criteria criarCriteriaParaFiltro(RecebimentoLancamentoRepositoryFiltro filtro) {
        Session session = manager.unwrap(Session.class);
        Criteria criteria = session.createCriteria(RecebimentoLancamento.class);
