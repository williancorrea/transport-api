...
@ControllerAdvice
public class PlanoContaExceptionHandler extends DefaultExceptionHandler {

    @Autowired
    private MessageSource messageSource;

    @ExceptionHandler({PlanoContaExceptionNaoEncontrado.class})
    public ResponseEntity<Object> handleBankUpdateNotFound(PlanoContaExceptionNaoEncontrado ex, WebRequest request, Locale loc) {
        String userMessage = messageSource.getMessage("recurso.plano-conta-nao-encontrado", null, loc);
