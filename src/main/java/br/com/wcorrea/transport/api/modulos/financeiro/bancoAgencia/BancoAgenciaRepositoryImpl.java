...
public class BancoAgenciaRepositoryImpl implements BancoAgenciaRepositoryQuery {
    ...
    @Override
    public Page<BancoAgencia> findAll(BancoAgenciaRepositoryFiltro filtro, Pageable pageable) {
     ...
     */
    public int quantidadeRegistrosFiltrados(BancoAgenciaRepositoryFiltro filtro) {
        Criteria criteria = criarCriteriaParaFiltro(filtro);
     ...
     * @return
     */
    private Criteria criarCriteriaParaFiltro(BancoAgenciaRepositoryFiltro filtro) {
        Session session = manager.unwrap(Session.class);
        Criteria criteria = session.createCriteria(BancoAgencia.class);
