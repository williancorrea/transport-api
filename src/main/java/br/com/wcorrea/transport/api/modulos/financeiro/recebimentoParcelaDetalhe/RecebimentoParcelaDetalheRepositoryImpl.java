...
public class RecebimentoParcelaDetalheRepositoryImpl implements RecebimentoParcelaDetalheRepositoryQuery {

    @PersistenceContext
    private EntityManager manager;

    @Override
    public Page<RecebimentoParcelaDetalhe> findAll(RecebimentoParcelaDetalheRepositoryFiltro filtro, Pageable pageable) {
     ...
     * @return
     */
    public int quantidadeRegistrosFiltrados(RecebimentoParcelaDetalheRepositoryFiltro filtro) {
        Criteria criteria = criarCriteriaParaFiltro(filtro);
     ...
     * @return
     */
    private Criteria criarCriteriaParaFiltro(RecebimentoParcelaDetalheRepositoryFiltro filtro) {
        Session session = manager.unwrap(Session.class);
        Criteria criteria = session.createCriteria(RecebimentoParcelaDetalhe.class);
