...
public class RecebimentoParcelaRepositoryImpl implements RecebimentoParcelaRepositoryQuery {

    @PersistenceContext
    private EntityManager manager;

    @Override
    public Page<RecebimentoParcela> findAll(RecebimentoParcelaRepositoryFiltro filtro, Pageable pageable) {
     ...
     * @return
     */
    public int quantidadeRegistrosFiltrados(RecebimentoParcelaRepositoryFiltro filtro) {
        Criteria criteria = criarCriteriaParaFiltro(filtro);
     ...
     * @return
     */
    private Criteria criarCriteriaParaFiltro(RecebimentoParcelaRepositoryFiltro filtro) {
        Session session = manager.unwrap(Session.class);
        Criteria criteria = session.createCriteria(RecebimentoParcela.class);
